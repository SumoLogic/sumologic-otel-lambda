# Sumo Logic Distribution for OpenTelemetry Python Lambda Layer 1.20.0 version

Sumo Logic lambda layers support:

- `Python` in versions `3.7, 3.8, 3.9, 3.10` and `3.11` runtimes (note that `Python 3.7` AWS runtime doesn't support `arm64` architecture)
